...
/// # Example
/// ```rust
/// use serato_tags::tag::serato32::{decode, encode};
///
...
/// # Example
/// ```
/// use serato_tags::tag::serato32::take;
/// use nom::Err;
...
/// # Example
/// ```
/// use serato_tags::tag::generic::Color;
/// use serato_tags::tag::serato32::take_color;
/// use nom::Err;
/// use nom::error::{Error, ErrorKind};
///
...
/// # Example
/// ```
/// use serato_tags::tag::serato32::take_u32;
/// use nom::Err;
/// use nom::error::{Error, ErrorKind};
///
